...
def bakery_by_id(id):
    ...
    bakery_dict = bakery.to_dict()
    response = make_response(jsonify(bakery_dict), 200, {"Content-Type": "application/json"})
    return response
...
def baked_goods_by_price():
    ...
    response = make_response(jsonify(baked_goods_by_price), 200, {"Content-Type": "application/json"})
    return response
